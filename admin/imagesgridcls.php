...
$images_grid = NULL; // Initialize page object first

class cimages_grid extends cimages {
	...
	// Page object name
	var $PageObjName = 'images_grid';

	// Grid form hidden field names
	var $FormName = 'fimagesgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["images"];
